...
function initThree(
  ...
  const displayFonts = ["'Anton'", "'Bebas Neue'", "'Monoton'", "'Righteous'", "'Fjalla One'", "'Limelight'", "'Rampart One'", "'Rubik Mono One'", "'Abril Fatface'", "'Bungee'", "'Bangers'"];
  const scriptFonts = ["'Pacifico'", "'Lobster'", "'Yellowtail'", "'Satisfy'", "'Shrikhand'", "'Permanent Marker'", "'Fascinate'"];
  const codeFonts = ["'Rubik Mono One'", "'Courier Prime'", "'Oswald'"];
